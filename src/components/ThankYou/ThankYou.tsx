      ...
      <Step.Body>
        <div className="flex h-full flex-col items-center justify-center">
          <svg
            ...
            height="80"
            viewBox="0 0 80 80"
            className={clsx(["mb-8 h-20 w-20", "md:mb-6 md:h-14 md:w-14"])}
          >
            <g fill="none">
          ...
          <h1 className="heading md:mb-1">Thank you!</h1>
          <p className="text-center text-body-lg leading-normal text-cool-gray">
